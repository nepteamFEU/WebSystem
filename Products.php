    ...
    public function add()
        ...
        if ($this->request->getMethod() == 'POST') 
        {
            ...
            [
                ...
                'ProductPrice'  => 'required|numveric|greater_than[0]'
            ];
    ...
    public function view($ProductID)
{
    ...
    public function showcase()
    {
        ...
        $total = $product_model->countAllResults(); // Get total product count
        $products = $product_model->paginate($perPage); // Fetch products for the current page

        $data = [
            'products' => $products,
            'pager' => $product_model->pager,
            'currentPage' => $page
        ];
